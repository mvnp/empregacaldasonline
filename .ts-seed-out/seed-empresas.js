...
async function seed() {
    ...
    if (vagasErr || !vagas) {
        console.error('❌ Falha ao buscar vagas:', vagasErr === null || vagasErr === void 0 ? void 0 : vagasErr.message);
        process.exit(1);
    }
    // Criar um Set único das empresas ativas baseadas na coluna de texto antiga 'empresa'
    const mapaEmpresas = new Map(); // NOME -> LOCAL
    ...
    for (const [nomeOriginal, local] of mapaEmpresas.entries()) {
        ...
        if (authErr || !(authUser === null || authUser === void 0 ? void 0 : authUser.user)) {
            console.error(`❌ Erro auth para ${email}:`, authErr === null || authErr === void 0 ? void 0 : authErr.message);
            continue;
        }
        ...
        if (pubErr || !publicUser) {
            console.error(`❌ Erro public.users para ${email}:`, pubErr === null || pubErr === void 0 ? void 0 : pubErr.message);
            continue;
        }
        ...
        if (empErr || !empresaDb) {
            console.error(`❌ Erro criar empresa ${nomeOriginal}:`, empErr === null || empErr === void 0 ? void 0 : empErr.message);
            continue;
        }
