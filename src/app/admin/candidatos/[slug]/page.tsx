...
export default async function CandidatoDetalhePage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    if (isNaN(id)) {
        return (
            <div style={{ textAlign: 'center', padding: '4rem 2rem' }}>
                <h2 style={{ fontSize: '1.25rem', fontWeight: 800, color: '#09355F', marginBottom: '0.5rem' }}>Candidato inválido</h2>
    ...
    if (!candidatoDb) {
        return (
            <div style={{ textAlign: 'center', padding: '4rem 2rem' }}>
                ...
                <p style={{ color: '#64748b', marginBottom: '1.5rem' }}>O candidato com ID {id} não existe no banco de dados.</p>
                <Link href="/admin/candidatos" className="btn-primary" style={{ padding: '0.65rem 1.25rem', borderRadius: 10, fontSize: '0.85rem' }}>
                    Voltar para Candidatos
                </Link>
            </div>
    ...
    const candidato = {
        ...
        cargo: candidatoDb.cargo_desejado || 'Não especificado',
