...
export default async function DetalheVagaCandidatoPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 1fr) 340px', gap: '2rem', alignItems: 'start' }} className="vaga-dashboard-grid">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', position: 'sticky', top: '5.5rem' }}>
                    ...
                    <div style={{ background: '#fff', padding: '2rem', borderRadius: 16, boxShadow: '0 4px 20px rgba(0,0,0,0.06)', border: '1px solid #2AB9C0' }}>
                        ...
                        <button style={{ 
                            ...
                            boxShadow: '0 8px 25px rgba(254,131,65,0.25)', border: 'none',
                            background: 'linear-gradient(135deg, #FE8341, #FBBF53)', color: '#fff', fontWeight: 800,
                            cursor: 'pointer' 
                        }}>
