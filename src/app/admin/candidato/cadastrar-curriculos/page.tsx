...
import {
    ...
    Wrench, Globe, FileText, Phone, DollarSign, ExternalLink
} from 'lucide-react'
import {
...
export default function CadastrarCurriculoCandidato() {
    ...
    useEffect(() => {
        async function load() {
            ...
            if (meuId) {
                setForm(prev => ({ ...prev, user_id: meuId }))
            } else {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            if (!resultado.success) {
                setLoading(false)
                setErro(resultado.error || 'Erro ao criar currículo.')
                return
            }

            // Redireciona para listagem de currículos
    ...
    return (
        <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '1.5rem' }}>
                ...
                <div>
                    <h1 style={{ fontSize: '1.5rem', fontWeight: 900, color: '#09355F' }}>Criar Novo Currículo</h1>
                    <p style={{ fontSize: '0.8rem', color: '#64748b' }}>Adicione as informações profissionais e gere um perfil para vagas específicas</p>
                </div>
            </div>
